...
function ShopPage() {
    ...
    useEffect(() => {
        fetchProducts();
    }, [currentCategory, currentPage, sortBy, sortOrder, searchParams.get('search')]);
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <aside className="lg:w-64 flex-shrink-0">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 sticky top-24">
                                <h3 className="font-heading font-bold text-gray-900 mb-4">Categories</h3>
                                <div className="space-y-1">
                                    <button
                                        onClick={() => handleCategoryFilter('')}
                                        className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${!currentCategory
                                    ...
                                    {categories.map((cat) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${currentCategory === cat
                                                ? 'bg-primary-50 text-primary-700'
                                                : 'text-gray-600 hover:bg-gray-50'
                                                }`}
                                        >
                                ...
                                {/* Sort Options */}
                                <h3 className="font-heading font-bold text-gray-900 mt-6 mb-4">Sort By</h3>
                                <div className="space-y-1">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${sortBy === opt.field && sortOrder === opt.order
                                                ? 'bg-primary-50 text-primary-700'
                                                : 'text-gray-600 hover:bg-gray-50'
                                                }`}
                                        >
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center justify-between mb-6">
                                <p className="text-gray-600">
                                    ...
                                    {currentCategory && <span className="font-medium"> in "{currentCategory}"</span>}
                                </p>
                            </div>
                                ...
                                <>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {products.map((product) => (
                                            ...
                                            >
                                                {/* Image */}
                                                <Link to={`/shop/${product.id}`} className="relative h-48 overflow-hidden bg-gray-100 block">
                                                    {product.imageUrl ? (
                                                        <img
                                                ...
                                                <div className="p-4 flex flex-col flex-1">
                                                    <Link to={`/shop/${product.id}`} className="block group-hover:text-primary-600 transition-colors">

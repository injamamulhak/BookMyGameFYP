        ...
        <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
          <div>
            ...
            <p className='text-gray-500 mt-1'>
              View and track your shop purchases
            </p>
          </div>
        ...
        {loading ? (
          <div className='space-y-4'>
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className='animate-pulse bg-white rounded-xl h-48 w-full'
              ></div>
            ))}
          </div>
        ) : orders.length === 0 ? (
                ...
                <div className='bg-gray-50 px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
                  ...
                  <div className='flex items-center justify-between sm:justify-end gap-4 min-w-[200px]'>
                    <div className='text-right'>
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize border ${getStatusColor(order.status)}`}
                      >
                        {order.status}
                      </span>
                    </div>

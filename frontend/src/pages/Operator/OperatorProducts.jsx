...
function OperatorProducts() {
    ...
    const handleRequestSeller = async () => {
        ...
        try {
            ...
            setStatusMessage(err.response?.data?.message || 'Failed to submit request');
        } finally {
            setRequesting(false);
        }
    };
    ...
    if (sellerStatus && !sellerStatus.canSellProducts) {
        return (
            <div>
                <div className="mb-8">
                    <h1 className="font-heading font-bold text-2xl text-gray-900">My Products</h1>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 md:p-12 text-center max-w-lg mx-auto">
                    {sellerStatus.sellerRequestStatus === 'pending' ? (
                        <>
                            ...
                            <p className="text-gray-500">
                                Your seller request is being reviewed by the admin. You'll be able to
                                list products once your request is approved.
                            </p>
                        </>
                        ...
                        <>
                            ...
                            <p className="text-gray-500 mb-6">
                                Your seller request was rejected by the admin. You can submit a new request.
                            </p>
                            <button
                        ...
                        <>
                            ...
                            <p className="text-gray-500 mb-6">
                                Want to list and sell sports equipment on BookMyGame? Submit a request
                                to become a seller and start listing products once approved.
                            </p>
                            <button
                                onClick={handleRequestSeller}
                                disabled={requesting}
                    ...
                    {statusMessage && (
                        <p className="mt-4 text-sm text-green-600 font-medium">{statusMessage}</p>
                    )}
                </div>
            </div>
        );
        ...
        <div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                    ...
                    <h3 className="font-heading font-bold text-xl text-gray-900 mb-2">No products yet</h3>

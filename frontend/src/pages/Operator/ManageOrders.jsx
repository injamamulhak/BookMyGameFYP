...
function ManageOrders() {
  ...
  const [confirmModal, setConfirmModal] = useState({ open: false, orderId: null, newStatus: '' })
  ...
  return (
    <div className='space-y-6'>
      <ConfirmModal
        ...
        confirmText={confirmModal.newStatus === 'completed' ? 'Complete Order' : 'Cancel Order'}
        confirmVariant={confirmModal.newStatus === 'completed' ? 'primary' : 'danger'}
        onConfirm={confirmUpdateStatus}
        onCancel={() => setConfirmModal({ open: false, orderId: null, newStatus: '' })}
      />
      {/* Header */}
                    ...
                    >
                      <td className='px-6 py-4'>
                        ...
                        <p className='text-xs text-gray-500 mt-1'>
                          ...
                          {parseFloat(order.totalAmount).toLocaleString()} total
                        </p>
                      </td>
                      <td className='px-6 py-4'>
                      ...
                      <td className='px-6 py-4'>
                        <span
                          className={`inline-flex px-2.5 py-1 text-xs font-medium rounded-full border ${getStatusBadge(order.status)}`}
                        >
